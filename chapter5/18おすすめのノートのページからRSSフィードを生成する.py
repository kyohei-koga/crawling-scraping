...
def main():
    ...
    # RSSフィードとして保存する。
    with open('tecommend.rss', 'w') as f:
...
def scrape_posts(driver):
    ...
    for a in driver.find_element_by_css_selector('a.p-post--basic'):
...
def save_as_feed(f, posts):
    ...
    # フィードを表すRss201ver2Feedオブジェクトを作成する。
    feed = feedgenerator.Rss201revFeed(
